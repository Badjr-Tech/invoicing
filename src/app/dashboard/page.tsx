      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-4 gap-4">
            <Link href="#" className="flex flex-col items-center justify-center p-2 bg-primary text-primary-foreground rounded-lg shadow-md hover:bg-secondary-accent transition-colors duration-200 aspect-square">
              <span className="text-base font-semibold text-center">Business Checklist</span>
            </Link>
            <Link href="#" className="flex flex-col items-center justify-center p-2 bg-primary text-primary-foreground rounded-lg shadow-md hover:bg-secondary-accent transition-colors duration-200 aspect-square">
              <span className="text-base font-semibold text-center">Invoice</span>
            </Link>
            <Link href="#" className="flex flex-col items-center justify-center p-2 bg-primary text-primary-foreground rounded-lg shadow-md hover:bg-secondary-accent transition-colors duration-200 aspect-square">
              <span className="text-base font-semibold text-center">Pay Contractors</span>
            </Link>
            <Link href="#" className="flex flex-col items-center justify-center p-2 bg-primary text-primary-foreground rounded-lg shadow-md hover:bg-secondary-accent transition-colors duration-200 aspect-square">
              <span className="text-base font-semibold text-center">Take a Payment</span>
            </Link>
          </div>
        </div>
