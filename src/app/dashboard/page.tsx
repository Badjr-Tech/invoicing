      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-4 gap-4">
            <Link href="#" className="flex flex-col items-center justify-center p-2 bg-[#0b2d65] text-white rounded-lg shadow-md hover:bg-secondary transition-colors duration-200 aspect-square">
