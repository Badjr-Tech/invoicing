      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link href="#" className="flex flex-col items-center justify-center p-4 bg-[#0b2d65] text-white rounded-lg shadow-md hover:bg-secondary transition-colors duration-200 aspect-square">
              <span className="text-lg font-semibold text-center">Business Checklist</span>
            </Link>
            <Link href="#" className="flex flex-col items-center justify-center p-4 bg-[#0b2d65] text-white rounded-lg shadow-md hover:bg-secondary transition-colors duration-200 aspect-square">
              <span className="text-lg font-semibold text-center">Invoice</span>
            </Link>
            <Link href="#" className="flex flex-col items-center justify-center p-4 bg-[#0b2d65] text-white rounded-lg shadow-md hover:bg-secondary transition-colors duration-200 aspect-square">
              <span className="text-lg font-semibold text-center">Pay Contractors</span>
            </Link>
            <Link href="#" className="flex flex-col items-center justify-center p-4 bg-[#0b2d65] text-white rounded-lg shadow-md hover:bg-secondary transition-colors duration-200 aspect-square">
              <span className="text-lg font-semibold text-center">Take a Payment</span>
            </Link>
          </div>
        </div>
