...
export default function ProductBasedBudgetIntroPage() {
  return (
    <div className="flex-1 p-6">
      <h1 className="font-display text-3xl font-semibold text-clay-800 mb-6">Product-Based Budget Calculator</h1>
      ...
      <div className="mb-8 bg-white p-6 rounded-card shadow-card"> {/* Changed mt-8 to mb-8 for spacing */}
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Need help pricing your products?</h2>
        <Link href="/dashboard/financial-tools/budget/pricing-tools/product" className="inline-block px-6 py-3 border border-transparent rounded-control shadow-sm text-lg font-medium text-white bg-invoice-blue hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-invoice-blue">
      ...
      <div className="bg-white p-6 rounded-card shadow-card mb-8">
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">How It Works:</h2>

        {/* Step 1: Copy the Template */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-clay-700 mb-2">Step 1: Get Your Budget Template</h3>
        ...
        {/* Step 2: Fill it Out */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-clay-700 mb-2">Step 2: Fill Out Your Spreadsheet</h3>
        ...
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-clay-700 mb-2">Step 3: Upload for Calculations</h3>
          <p className="text-lg text-clay-700 mb-4">
