  ...
  return (
    <div className="flex-1 p-6">
      ...
      <div className="mt-8 text-center">
        <Link href="/dashboard/financial-tools/budget/service-based" className="inline-block px-8 py-4 border border-transparent text-xl font-medium rounded-control text-white bg-ember-600 hover:bg-ember-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sage-300">
