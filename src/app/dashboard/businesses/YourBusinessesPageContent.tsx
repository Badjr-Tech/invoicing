  ...
  return (
    <>
      ...
      <p className="mt-4 text-foreground">
        ...
        business type, tax status, and legal business name. <strong>Your legal business name is the name
        you used when registering your business</strong>—if you’re a sole proprietor, it’s your personal name.
        <strong>For businesses with DBAs or trade names, the business title should reflect the DBA,</strong> while the
