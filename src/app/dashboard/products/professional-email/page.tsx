  ...
  return (
    <div className="flex-1 p-6">
      <div className="flex items-center mb-6">
        <MailCheck size={48} className="text-sage-700" />
        <h1 className="font-display text-3xl font-semibold text-clay-800 ml-4">Professional Email Product</h1>
      </div>
      <div className="bg-white p-6 rounded-card shadow-card">
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Simple Professional Email via Routing</h2>
        <p className="text-lg text-clay-600 mb-6">
          Skip the tech stress and get a professional email that matches your business name. We’ll handle the setup and routing so you can send and receive emails from your own address using the inbox you already know. It’s easy, reliable, and makes your business look polished.
        </p>
