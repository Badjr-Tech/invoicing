  ...
  return (
    <div className="flex-1 p-6">
      <div className="flex items-center mb-6">
        <Brush size={48} className="text-blue-600" />
        <h1 className="text-4xl font-bold text-gray-800 ml-4">Portfolio Product</h1>
      </div>
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Portfolio Product</h2>
