...
export default function Product15Page() {
  ...
  return (
    <div className="flex-1 p-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="font-display text-3xl font-semibold text-clay-800 ml-4">Product 1.5</h1>
      </div>
      <div className="bg-white p-6 rounded-card shadow-card">
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Product 1.5</h2>
        <p className="text-lg text-clay-600 mb-6">
          This is a preview of Product 1.5. Add this product to your account to start using it.
        </p>
        <form action={formAction}>
          <input type="hidden" name="productId" value="product-1-5" />
          <button
            type="submit"
