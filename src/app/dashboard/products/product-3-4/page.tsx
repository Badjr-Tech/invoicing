  ...
  return (
    <div className="flex-1 p-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="font-display text-3xl font-semibold text-clay-800 ml-4">Product 3.4</h1>
      </div>
      <div className="bg-white p-6 rounded-card shadow-card">
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Product 3.4</h2>
