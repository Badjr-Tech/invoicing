  ...
  return (
    <div className="flex-1 p-6">
      <div className="flex items-center mb-6">
        <CopyPlus size={48} className="text-red-600" />
        <h1 className="font-display text-3xl font-semibold text-clay-800 ml-4">Campaign Product</h1>
      </div>
      <div className="bg-white p-6 rounded-card shadow-card">
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Campaign Product</h2>
        <p className="text-lg text-clay-600 mb-6">
          This is a preview of the Campaign product. Add this product to your account to start using it.
        </p>
        <form action={formAction}>
          <input type="hidden" name="productId" value="campaign" />
          <button
            type="submit"
