  ...
  return (
    <div className="flex-1 p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="font-display text-3xl font-semibold text-clay-800">Your Business Streams</h1>
      ...
      <div className="bg-white p-6 rounded-card shadow-card mb-6">
        <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Why Categorize Services?</h2>
        ...
        <p className="text-clay-700 font-semibold">
