...
export default function ServicesPageClient({
  ...
  return (
    <div className="p-6">
      <h1 className="font-display text-3xl font-semibold text-clay-800 mb-6">Services</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Your Services</h2>
