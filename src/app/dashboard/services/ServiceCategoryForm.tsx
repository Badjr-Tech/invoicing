...
export default function ServiceCategoryForm({ onSubmissionSuccess, businesses }: { onSubmissionSuccess?: () => void; businesses: { id: number; businessName: string }[] }) {
  ...
  return (
    <div>
      <h2 className="font-display text-xl font-semibold text-clay-800 mb-4">Add New Category</h2>
      <form action={formAction} className="space-y-6 bg-white p-6 rounded-card shadow-card">
        ...
        <div>
          <label htmlFor="customId" className="block text-sm font-medium text-clay-700">
            Custom ID (Optional)
          </label>
          <div className="mt-1">
            <input
